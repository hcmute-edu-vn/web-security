...
@WebServlet(urlPatterns = { "/system/products/images/create", "/system/products/images/create/" })
public class CreateProductImageServlet extends HttpServlet {
  private static final long serialVersionUID = 1L;

  public CreateProductImageServlet() {
    super();
  }
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    productImageService.getProductImageForm();
  }
